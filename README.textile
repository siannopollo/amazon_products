...
bq. search = AmazonProducts::Search.new('Books', 'knitting')
bq. results = search.execute
bq. @first_result = results.first
...
bq. require 'amazon_products'
bq. lookup = AmazonProducts::Lookup.new('0834003503', 'ISBN')
bq. @result = lookup.execute
